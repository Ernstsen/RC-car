...
class VehicleController(VehicleControllerI):
    ...
    def set_drive(self, val: int) -> bool:
        return server.send(self.connection, "DRIVE;" + str(val))

    def set_gear(self, val: int) -> bool:
        return server.send(self.connection, "GEAR;" + str(val))

    def set_throttle(self, val: int) -> bool:
        return server.send(self.connection, "THROTTLE;" + str(val))

    def set_direction(self, val: int) -> bool:
        return server.send(self.connection, "DIRECTION;" + str(val))
