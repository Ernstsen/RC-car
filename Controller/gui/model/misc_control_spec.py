...
class MiscControlSpec(object):
    ...
    def __init__(self, display_name: str, method: Callable[[any], None], param_type: type,
                 row: int, column: int, description: str = None):
        """
        :param display_name: the name to be displayed in the GUI for this setting
        :param method: the method to be called upon change. Must atke exactly one argument of the type 'param_type'
